...
pub enum ExecutionError {
    ...
    /// MySocial Move Bytecode Verification Error.
    MySocialMoveVerificationError,
    ...
    /// MySocial Move Bytecode verification timed out.
    MySocialMoveVerificationTimedout,
            ...
            S: Serializer,
        {
            if serializer.is_human_readable() {
                let readable = match self.clone() {
                    ...
                    Self::MySocialMoveVerificationError => {
                        ReadableExecutionError::MySocialMoveVerificationError
                    }
                    ...
                    Self::MySocialMoveVerificationTimedout => {
                        ReadableExecutionError::MySocialMoveVerificationTimedout
                    }
                ...
                let binary = match self.clone() {
                    ...
                    Self::MySocialMoveVerificationError => {
                        BinaryExecutionError::MySocialMoveVerificationError
                    }
                    Self::MovePrimitiveRuntimeError { location } => {
                    ...
                    Self::MySocialMoveVerificationTimedout => {
                        BinaryExecutionError::MySocialMoveVerificationTimedout
                    }
                    Self::SharedObjectOperationNotAllowed => {
