...
///                 =/ certificate-denied
///                 =/ myso-move-verification-timedout
...
/// myso-move-verification-error                         = %x0a
...
/// myso-move-verification-timedout                      = %x1e
            ...
            S: Serializer,
        {
            if serializer.is_human_readable() {
                let readable = match self.clone() {
                    ...
                    Self::MySoMoveVerificationError => {
                        ReadableExecutionError::MySoMoveVerificationError
                    }
                    ...
                    Self::MySoMoveVerificationTimedout => {
                        ReadableExecutionError::MySoMoveVerificationTimedout
                    }
                ...
                let binary = match self.clone() {
                    ...
                    Self::MySoMoveVerificationError => {
                        BinaryExecutionError::MySoMoveVerificationError
                    }
                    Self::MovePrimitiveRuntimeError { location } => {
                    ...
                    Self::MySoMoveVerificationTimedout => {
                        BinaryExecutionError::MySoMoveVerificationTimedout
                    }
                    Self::SharedObjectOperationNotAllowed => {
