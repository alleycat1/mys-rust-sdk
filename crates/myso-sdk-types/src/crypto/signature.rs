...
/// A basic signature
///
/// This enumeration defines the set of simple or basic signature schemes supported by MySo. Most
...
/// Flag use to disambiguate the signature schemes supported by MySo.
///
/// # BCS
///
/// The BCS serialized form for this type is defined by the following ABNF:
