//! Core type definitions for the [MySo] blockchain.
//!
//! [MySo] is a next-generation smart contract platform with high throughput, low latency, and an
//! asset-oriented programming model powered by the Move programming language. This crate provides
//! type definitions for working with the data that makes up the [MySo] blockchain.
//!
//! [MySo]: https://myso.io
//!
//! # Feature flags
...
//! new variants and types as they are released to MySo's `testnet` network.
//!
