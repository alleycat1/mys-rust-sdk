...
pub struct Validator {
    ...
    /// The total number of MSO tokens in this pool plus
    ...
    pub pending_total_mso_withdraw: Option<BigInt>,
    ...
    /// The total number of MSO tokens in this pool.
    pub staking_pool_mso_balance: Option<BigInt>,
