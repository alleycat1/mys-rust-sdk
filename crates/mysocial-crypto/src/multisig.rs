...
use crate::Verifier;
use mysocial_sdk_types::MultisigAggregatedSignature;
use mysocial_sdk_types::MultisigCommittee;
use mysocial_sdk_types::MultisigMemberPublicKey;
use mysocial_sdk_types::MultisigMemberSignature;
use mysocial_sdk_types::UserSignature;
...
impl MultisigAggregator {
    pub fn new_with_transaction(
        committee: MultisigCommittee,
        transaction: &mysocial_sdk_types::Transaction,
    ) -> Self {
        Self {
            committee,
    ...
    pub fn new_with_message(
        committee: MultisigCommittee,
        message: &mysocial_sdk_types::PersonalMessage<'_>,
    ) -> Self {
        Self {
            committee,
            signatures: Default::default(),
