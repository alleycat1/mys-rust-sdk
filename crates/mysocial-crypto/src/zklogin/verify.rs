...
use mysocial_sdk_types::Bn254FieldElement;
use mysocial_sdk_types::CircomG1;
use mysocial_sdk_types::CircomG2;
use mysocial_sdk_types::Ed25519PublicKey;
use mysocial_sdk_types::Jwk;
use mysocial_sdk_types::Secp256k1PublicKey;
use mysocial_sdk_types::Secp256r1PublicKey;
use mysocial_sdk_types::SimpleSignature;
use mysocial_sdk_types::ZkLoginInputs;
use mysocial_sdk_types::ZkLoginProof;
...
mod test {
    use super::*;
    use mysocial_sdk_types::Ed25519Signature;
