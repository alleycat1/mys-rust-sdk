...
use crate::Verifier;
use mso_sdk_types::MultisigAggregatedSignature;
use mso_sdk_types::MultisigCommittee;
use mso_sdk_types::MultisigMemberPublicKey;
use mso_sdk_types::MultisigMemberSignature;
use mso_sdk_types::UserSignature;
...
impl MultisigAggregator {
    pub fn new_with_transaction(
        committee: MultisigCommittee,
        transaction: &mso_sdk_types::Transaction,
    ) -> Self {
        Self {
            committee,
    ...
    pub fn new_with_message(
        committee: MultisigCommittee,
        message: &mso_sdk_types::PersonalMessage<'_>,
    ) -> Self {
        Self {
            committee,
            signatures: Default::default(),
