...
use query_types::DefaultMySonsNameQuery;
use query_types::DefaultMySonsNameQueryArgs;
...
use query_types::ResolveMySonsQuery;
use query_types::ResolveMySonsQueryArgs;
...
/// The GraphQL client for interacting with the MySo blockchain.
